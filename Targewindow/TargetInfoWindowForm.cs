        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (currentTarget != null)
                {
                    ...
                    TargetHPLabel.Text = String.Format("{0}/{1} {2:0.00}%", currentTarget.Structure.CurrentHP, currentTarget.Structure.MaxHP, 100 * (float)currentTarget.Structure.CurrentHP / (float)currentTarget.Structure.MaxHP);
